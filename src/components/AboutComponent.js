    ...
    <div className="container">
      ...
      <div className="row row-content">
        <div className="col-sm-6">
          <h3>Our Mission</h3>
          <p>
            We present a curated database of the best telescopes in the vast
            ...
            staff personally verify each telescope to make sure that they are up
            to our standards. We also present a platform for campers to share
            reviews on telescopes they have visited with each other.
          </p>
        </div>
        <div className="col-sm-6">
          <Card>
            ...
            <CardBody>
              <dl className="row">
                ...
                <dt className="col-6">No. of Telescopes in 2019</dt>
